...
ax1.plot(time_n0, cwnd_n0,
         label='Job 1 (CWND)',
         linewidth=1.5,
         color='#FF0000')

ax1.plot(time_m0, cwnd_m0,
         label='Job 2 (CWND)',
         linewidth=1.5,
         dashes=(10, 5),
         color='#0000FF')

ax1.plot(time_q, queue_size,
         label='Queue Size',
         linewidth=2,
         color='#00AA00')

# --- Axis settings ---
ax1.set_xlabel('Time (µs)', fontsize=35)
ax1.set_ylabel('CWND (Packets)', fontsize=35)
...
output_filename = 'cwnd_queue_comparison_fanin44.pdf'
